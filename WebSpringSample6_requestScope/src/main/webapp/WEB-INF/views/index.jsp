...
<body>
	...
	<a href="test3">test3 - RequestScope (ModelAndView mav)</a><br>
...
------------------------------
 ...
 3) Spring MVC는 요청이 발생되면 요청 주소를 분석하여 그와 매핑되어 있는 메서드를 호출하고 메서드가 반환하는 정보를 토대로 응답결과를 생성하여 클라이언트에게 전달합니다.
...
- redirect는 클라이언트의 요청에 의해 서버의 db에 변화가 생기는 작업에 사용된다.
- forward는 특정 url에 대해 외부에 공개되지 말아야 하는 부분을 가리는데 사용하거나 조회를 위해 사용된다.
 -->